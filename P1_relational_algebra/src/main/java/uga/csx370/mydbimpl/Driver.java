...
public class Driver {
    ...
    public static void main(String[] args) {
        ...
        Relation takes2003 = ra.select(takesRel,
            new PredicateImpl(takesRel.getAttrIndex("year"), Cell.val(2003), PredicateImpl.Operator.GE));
        ...
        Relation renamedCourse = ra.rename(courseRel, List.of("course_id"), List.of("course_id_course"));
        ...
        Relation renamedStudentRel = ra.rename(studentRel, List.of("ID"), List.of("student_ID"));
